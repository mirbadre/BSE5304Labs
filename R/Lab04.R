...
# Starting Lab 04 Calibration O_O
...
#
source('https://raw.githubusercontent.com/mirbadre/BSE5304Labs/main/R/TMWBFuncs.R')
...
#Here is the fixed Snow function
...
source("https://raw.githubusercontent.com/mirbadre/BSE5304Labs/main/R/TMWBmodel.R")
...
#[1] 254
# So from above we are going to visually "guestimate" that S should be somewhere between 
...
CNmodeldf <- CNModel(BasinData,CNavg = 75,IaFrac = 0.05,fnc_slope=0,fnc_aspect=0,func_DAWC=.3,func_z=1000,fnc_fcres=.3)
